...
use App\Http\Resources\Api\V1\Lookups\TitlesResource;
...
class TitlesController extends Controller
{
    ...
    public function index()
    {
        ...
        return response()->json(TitlesResource::collection($titles));
    }
    ...
    public function show($id)
    {
        ...
        return response()->json(new TitlesResource($titles));
    }
